...
public class Menu {
	...
	public String writeOutput(){
		String output = "<b>Feed: </b>" + getFeed() + "<br>" + "<b>Prime Rib: </b>" + getPrime() + "<br>" + "<b>Name: </b>" + getName() + "<br>" + "<b>Azure: </b>" + getAzure() + "<br>" + "<b>Logging:</b>" + getLogging() + "<br>" + "<b>Monitoring:</b> " + getMonitoring() + "<br>" + "<b>Rabbit: </b> " + getRabbitMQ();
		return output; 
	}		
}
